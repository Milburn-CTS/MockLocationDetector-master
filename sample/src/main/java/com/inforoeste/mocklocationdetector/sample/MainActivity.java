...
//        mLocationRequest.setFastestInterval(5000);
    ...
    private void updateUI() {
        ...
        if (mockLocationAppsPresent) {
            mAreMockLocationAppsPresentTextView.setTextColor(Color.RED);
        } else {
            mAreMockLocationAppsPresentTextView.setTextColor(Color.GREEN);
        }
        ...
        if (isAllowMockLocationsON) {
            mIsMockLocationsOnTextView.setTextColor(Color.RED);
        } else {
            mIsMockLocationsOnTextView.setTextColor(Color.GREEN);
        }
    }
}
